  ...
  return (
    <div>
      ...
      <p className="mb-6 text-xs text-[var(--text-muted)]">
        Sessões, conversão, origem de tráfego e páginas mais vistas do site agora ficam na aba{" "}
        <a href="/dashboard/analytics-site" className="text-[var(--series-1)] hover:underline">Analytics do Site</a>
        {" "}(dentro desse mesmo grupo Marketing).
      </p>
