  ...
  return (
    <div>
      <p className="mb-4 text-sm text-[var(--text-secondary)]">
        ...
        seguinte (nunca negativo — estoque físico não existe abaixo de zero). Colunas com fundo
        azulado são <strong>projetadas</strong>; o resto é <strong>realizado</strong>, reconstruído
        a partir do estoque atual andando pra trás até set/2025 (não é dado gravado historicamente
        — é a matemática de conservação de estoque, já que o snapshot só guarda o valor de agora).
        Estoque ideal = vendas projetadas × cobertura (meses, editável por grupo). Falta comprar nos
        meses futuros considera que NADA é comprado (recebimento futuro = 0) — de propósito, pra
        mostrar o tamanho real do buraco se não agir.
      </p>
      ...
      <p className="mb-4 text-xs text-[var(--text-muted)]">
        ...
        estoque de outro jeito (ex: comprado pronto de fornecedor) pode ter reconstruído um valor
        maior que zero no passado — os meses mais recentes (perto de hoje) são os mais confiáveis, já
