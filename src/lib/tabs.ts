...
export const TABS: TabEntry[] = [
  ...
  { key: "curva-vida-colecao", label: "Cohort", href: "/dashboard/curva-vida-colecao", group: "estoque" },
  ...
  { key: "contatos-vendedores", label: "Contatos por Vendedor", href: "/dashboard/contatos-vendedores", group: "clientes" },
